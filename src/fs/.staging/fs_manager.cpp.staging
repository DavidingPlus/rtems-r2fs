...
#include "cache/dir_data_block_cache.h"
#include "cache/node_block_cache.h"
#include "cache/SIT_NAT_cache.h"
#include "fs/fd_array.h"
#include "fs/file.h"
#include "fs/srmap_utils.h"
#include "fs/super_manager.h"
#include "fs/replace_protect.h"
#include "fs/server_thread.h"
#include "fs/write_back_helper.h"
#include "fs/replace_protect.h"
#include "journal/journal_container.h"
#include "utils/r2fs_exceptions.h"
#include "utils/lock_guards.h"
...
file_system_manager::~file_system_manager()
{
    ...
    if (ret != 0)
        R2FS_LOG(R2FS_LOG_WARNING, "file system manager: destruct fs freeze lock failed.");
}
...
void file_system_manager::fini()
{
    ...
    R2FS_LOG(R2FS_LOG_INFO, "destructed all file system cache.");
}
